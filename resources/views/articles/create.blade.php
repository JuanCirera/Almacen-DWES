<x-app-layout>
    <div class="py-12">
        <h4 class="text-center text-xl mb-4">Nuevo artículo</h4>
        <div class="mx-auto w-full max-w-lg">
            <form action="{{ route('articles.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        type="number" step=".01" name="precio" value="{{ old('precio') }}">
                    @error('precio')
                        <p class="mt-2 text-red-600">{{$message}}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    <img src="{{ Storage::url('no-image.png') }}" alt="" class="rounded-lg" id="imagen">
                </div>
